...
const S = {
  ...
  calMonthTitle: { margin: 0, fontSize: 19, fontWeight: 700, letterSpacing: "-.02em", minWidth: 170, textAlign: "center" },
  ...
  calScroll: { flex: 1, overflowY: "auto", border: "1px solid #e3e8f0", borderRadius: 12, minHeight: 0 },
  calGrid: { display: "grid", gridTemplateColumns: "repeat(7,1fr)", gridAutoRows: "minmax(150px, auto)",
    gap: 1, background: "#e3e8f0" },
  calDow: { background: "#fbfcfe", padding: "11px 0", textAlign: "center", fontSize: 11.5, fontWeight: 700,
    color: "#6b7587", letterSpacing: ".04em", position: "sticky", top: 0, zIndex: 2 },
  calCell: { background: "#fff", padding: "7px 8px", display: "flex", flexDirection: "column",
    minHeight: 0, overflow: "hidden" },
  calCellTop: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 5, flexShrink: 0 },
  calCellTopClickable: { cursor: "pointer", borderRadius: 7, padding: "3px 5px", margin: "-3px -5px 4px",
    border: "1px solid transparent" },
  calCellToday: { background: "#fff7f0" },
  calDayNum: { fontSize: 12.5, fontWeight: 600, color: "#6b7587" },
  ...
  calTasks: { display: "flex", flexDirection: "column", gap: 4, overflowY: "auto", minHeight: 0 },
  calTask: { display: "flex", alignItems: "center", gap: 6, background: "#f6f8fb", borderLeft: "3px solid #ccc",
    borderRadius: 5, padding: "5px 7px", cursor: "pointer", border: "none", borderLeftStyle: "solid",
  ...
  calTaskText: { fontSize: 11.5, color: "#2a3346", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
